...
class Car {
  ...
  fill(gallons){
   ...
   drive(distance){
    const milesDrivabale = this.tank * this.milesPerGallon
    if(distance <= milesDrivabale){
      this.odometer = this.odometer + distance
    this.tank = this.tank - (distance/this.milesPerGallon);
    }else{
      this.odometer = this.odometer + milesDrivabale;
      this.tank = 0
...
class ProjectManager extends Instructor{
  constructor(instrAttrs){
    super(instrAttrs);
    this.gradClassName = instrAttrs.gradClassName;
    this.favInstructor = instrAttrs.favInstructor;
  }
   standUp(channel){
